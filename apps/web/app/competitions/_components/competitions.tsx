  ...
  return (
    <main className="flex-grow container mx-auto px-4 py-8">
      <div className="flex items-center gap-2 mb-6">
        {activeTab === "upcoming" && (
          <>
            <h1 className="text-3xl font-bold">Próximas competencias oficiales en México</h1>
        ...
        {activeTab === "current" && (
          <>
            <h1 className="text-3xl font-bold">Competencias actuales en México</h1>
            <Badge className="!h-fit">
        ...
        {activeTab === "past" && (
          <>
            <h1 className="text-3xl font-bold">Competencias pasadas en México</h1>
            <Badge className="!h-fit">
      ...
      <div className="flex justify-between items-center mb-4">
        <Tabs className="!w-full" defaultValue="upcoming" onValueChange={(value) => { setActiveTab(value); }}>
          <TabsList className="!grid !w-[400px] !grid-cols-2">
            <TabsTrigger value="upcoming">Upcoming</TabsTrigger>
            {currentCompetitions.length > 0 && <TabsTrigger value="current">Current</TabsTrigger>}
            <TabsTrigger value="past">Past</TabsTrigger>
          </TabsList>
        </Tabs>
        <ToggleGroup onValueChange={(value) => value && setViewMode(value)} type="single" value={viewMode}>
                ...
                {upcomingCompetitions.map((competition, index) => {
                  ...
                  return (
                    <TableRow key={competition.id}>
                      ...
                      <TableCell>{formatCompetitionDateSpanish(competition)}</TableCell>
                    </TableRow>
                  )
                })}
              </TableBody>
              ...
              {upcomingCompetitions.map((competition) => {
                ...
                return (
                  <Card key={competition.id}>
                    ...
                    <CardContent>
                      <p>Join fellow speedcubers for an exciting WCA competition!</p>
                    </CardContent>
                    <CardFooter>
                      {/* <Button
              ...
              {pastCompetitions.map((competition) => {
                ...
                return (
                  <Card key={competition.id}>
                    ...
                    <CardContent>
                      <p>Check out the results from this exciting competition!</p>
                    </CardContent>
                    <CardFooter>
      ...
      {activeTab === "upcoming" && (
        <div className="mt-12">
          <h2 className="text-2xl font-bold mb-4">¿Quieres organizar una competencia?</h2>
          <p className="mb-4">
            Si estás interesado en organizar una competencia de la WCA en México, por favor ponte en contacto con nosotros. Podemos proporcionar orientación y apoyo durante todo el proceso.
          </p>
